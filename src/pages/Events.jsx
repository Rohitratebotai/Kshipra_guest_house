  ...
  return (
    <div className="pt-0">
      ...
      <div className="fixed bottom-20 left-0 right-0 flex justify-between px-6 md:px-12 z-50">
        ...
        <button
          className="fixed top-1/4 md:top-1/5 right-4 md:right-10 -translate-y-1/2 bg-blue-600 text-white px-5 py-3 md:px-6 md:py-4 rounded-full shadow-lg hover:bg-blue-700 transition-all font-medium z-50"
