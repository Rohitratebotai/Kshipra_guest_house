...
import img_2 from "../assets/kdn/img_13.jpg"; // Corrected the file path
import img_3 from "../assets/kdn/img_24.jpg";
...
export function Home() {
  ...
  function handleNavigate() {
    window.open('https://booking.kabanadenatureresort.com/hotel/hotel-details?hotel_id=96', '_blank');
  }
  ...
  return (
    <>
      ...
      <div className="fixed bottom-20 left-0 right-0 flex justify-between px-6 md:px-12 z-50">
        ...
        <button
          className="fixed top-1/5 right-4 md:right-10 -translate-y-1/2 bg-blue-600 text-white px-5 py-3 md:px-6 md:py-4 rounded-full shadow-lg hover:bg-blue-700 transition-all font-medium z-50"
