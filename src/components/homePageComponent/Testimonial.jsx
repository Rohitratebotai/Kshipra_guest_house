...
export function Testimonial() {
  const testimonialData = [
    {
      context_text:
        "Kabana de Nature combines luxury, beautiful views, excellent service, and top-notch amenities, offering a perfect blend of relaxation and adventure.",
      name: "Harsh Vardhan",
      rating: 5,
    },
    {
      context_text:
        "This is truly an untouched place to stay amidst breathtaking nature. The location of the resort is simply wonderful. The staff is courteous and helpful although you won't find extensive cuisine. The food was freshly prepared and served hot. There wasn't any television and this was the best part. I loved this place and definitely want to go back again",
      name: "SOUMYATA TRIPATHI",
      rating: 5,
    },
    {
      context_text:
        "This is very beautiful property. Our stay here is very comfortable. Staff is very cooperative. Food is good. We were in the lap of nature for tree days. Cottage were very neat and clean. We also had great party time. I would like to come here again and again.",
      name: "anupriya niranjan",
      rating: 5,
    },
    {
      context_text:
        "I share my experience of 2 days stay with family at Kabana de Nature. Its Very nice property located just in the lap of nature.Had lot of partying fun too. Comfortable stay, good food… Cant put all my feelings in words. Surely a place to visit again and again. Would love to stay for a longer duration…",
      name: "Rajeev Jindal",
      rating: 5,
    },
    {
      context_text:
        "Experience worth of every penny spent. Amazing and relaxing vacation at kabana. Hotel staff was quite cooperative and was always available to help and assist. Separate section for kids in the room were icing on the cake. Additionally, whole hotel staff made sure that we have best of New year celebrations. Must recommend for short and sweet stay with family.",
      rating: 5,
    },
    {
      context_text:
        "i am sharing my experience of two days stay. This place is in the lap of nature, very neat and clean, Laban means huts,cabins, like heaven. Staff is too much cooperative and honest. Very calm place for meditation. Management is also good.",
      rating: 5,
    },
  ];
